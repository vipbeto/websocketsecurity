...
fun_udp1 () {
    ...
    menu
	    ...
	    inst_udp () {
            ...
            wget https://www.dropbox.com/s/bt6bchokyte6mff/badvpn-udpgw -o /dev/null
			wget https://raw.githubusercontent.com/vipbeto/websocketsecurity/main/F2/badvpn/antcrashvpn.sh -o /dev/null
